//! Specifications for KioskPin aggregate
//!
...
// Each predicate implements `Specification<KioskPin>` and can be combined
...
//
// pub struct ActiveKioskPinSpec;
// impl Specification<KioskPin> for ActiveKioskPinSpec {
//     fn is_satisfied_by(&self, e: &KioskPin) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
