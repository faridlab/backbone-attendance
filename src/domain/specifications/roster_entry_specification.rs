//! Specifications for RosterEntry aggregate
//!
...
// Each predicate implements `Specification<RosterEntry>` and can be combined
...
//
// pub struct ActiveRosterEntrySpec;
// impl Specification<RosterEntry> for ActiveRosterEntrySpec {
//     fn is_satisfied_by(&self, e: &RosterEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
