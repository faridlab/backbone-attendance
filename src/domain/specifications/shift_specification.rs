//! Specifications for Shift aggregate
//!
...
// Each predicate implements `Specification<Shift>` and can be combined
...
//
// pub struct ActiveShiftSpec;
// impl Specification<Shift> for ActiveShiftSpec {
//     fn is_satisfied_by(&self, e: &Shift) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
