//! Specifications for AttendanceClock aggregate
//!
...
// Each predicate implements `Specification<AttendanceClock>` and can be combined
...
//
// pub struct ActiveAttendanceClockSpec;
// impl Specification<AttendanceClock> for ActiveAttendanceClockSpec {
//     fn is_satisfied_by(&self, e: &AttendanceClock) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
