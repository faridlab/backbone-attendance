//! Domain policy for Shift aggregate
//!
...
/// Domain policy for Shift — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Shift>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ShiftDomainPolicy = PermitAllPolicy<Shift>;
