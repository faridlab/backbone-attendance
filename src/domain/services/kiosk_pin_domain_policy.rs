//! Domain policy for KioskPin aggregate
//!
...
/// Domain policy for KioskPin — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<KioskPin>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type KioskPinDomainPolicy = PermitAllPolicy<KioskPin>;
