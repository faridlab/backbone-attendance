//! Domain policy for OvertimeRequest aggregate
//!
...
/// Domain policy for OvertimeRequest — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OvertimeRequest>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OvertimeRequestDomainPolicy = PermitAllPolicy<OvertimeRequest>;
