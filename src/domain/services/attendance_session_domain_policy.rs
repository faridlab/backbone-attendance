//! Domain policy for AttendanceSession aggregate
//!
...
/// Domain policy for AttendanceSession — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<AttendanceSession>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type AttendanceSessionDomainPolicy = PermitAllPolicy<AttendanceSession>;
