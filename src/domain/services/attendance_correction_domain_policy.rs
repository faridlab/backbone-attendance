//! Domain policy for AttendanceCorrection aggregate
//!
...
/// Domain policy for AttendanceCorrection — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<AttendanceCorrection>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type AttendanceCorrectionDomainPolicy = PermitAllPolicy<AttendanceCorrection>;
